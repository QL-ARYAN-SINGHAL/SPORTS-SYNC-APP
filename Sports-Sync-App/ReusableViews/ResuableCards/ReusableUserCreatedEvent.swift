            ...
            HStack(spacing: 16) {
                ...
                VStack(spacing : 1){
                    ...
                    VStack {
                        ...
                        Text(eventInfoDataModal.selectedStadium ?? "")
...
#Preview {
    ReusableUserCreatedEvent(stadiumcardData: HomeCardsDataModal(
    ...
    ), eventInfoDataModal: EventInformationDataModal(searchText: "", eventName: "IPL", eventDate: "5 october", sportsName: "Cricket", eventTime: "6pm", selectedStadium: "Wankhade", stadium: "", showStadiumDetail: true))
}
